                        ...
                        <div class="mdform">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="<?php echo $empleadoParaModificar->nombre ?>" type="text"
                                           class="form-control" id="nombre">
                                </div>
                                <div class="col-md-6">
                                    <label for="form1-lname">Apellido</label>
                                    <input value="<?php echo $empleadoParaModificar->apellido ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="<?php echo $empleadoParaModificar->dni ?>" type="text"
                            ...
                            <div class="row">
                                <div class="form-group md-form-group col-md-6">
                                    ...
                                    <div class="input-group datepicker-input-group date">
                                        <input value="<?php echo $empleadoParaModificar->fehca_inicio_vacaciones ?>"
                                               class="form-control" id="fecha_inicio_vacaciones">
                                        <span class="input-group-addon" id="date-perso"><i
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group datepicker-input-group date">
                                        <input value="<?php echo $empleadoParaModificar->fehca_fin_vacaciones ?>"
                                               class="form-control" id="fecha_fin_vacaciones">
                                        <span class="input-group-addon" id="date-perso"><i
                                                    class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group datepicker-input-group date">
                                        <input value="<?php echo $empleadoParaModificar->fecha_nacimiento ?>"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select type="text" class="form-control" id="permisos">
                                        <option value="0" <?php echo $resultado = 0 == $empleadoParaModificar->id_permiso ? "selected" : ""; ?>>
                                            Permiso Administrador
                                        </option>
                                        <option value="1" <?php echo $resultado = 1 == $empleadoParaModificar->id_permiso ? "selected" : ""; ?>>
                                            Permiso Usuario
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="<?php echo $empleadoParaModificar->salario_bruto ?>" type="number"
